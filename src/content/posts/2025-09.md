...
::: FastJSON 1.x 与 2.x 对于内部类兼容处理不一致
...
::: Apache HttpClient 5.x 默认中文不编码会导致按 UTF-8 接收乱码
详见  部门公共包（产品增长研发小组定制版）中 MarketCenter Common 的 3.0.9
...
[Spring Framework 6.1 Release Notes · spring-projects/spring-framework Wiki](https://github.com/spring-projects/spring-framework/wiki/Spring-Framework-6.1-Release-Notes#parameter-name-retention)
